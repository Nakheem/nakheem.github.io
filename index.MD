...
<head>
  ...
  <!-- Favicons -->
  <link rel="apple-touch-icon" sizes="220x220" href="assets/img/apple-touch-icon.png">
  <link rel="icon" type="image/png" sizes="64x64" href="assets/img/favicon-32x32.png">
...
<body>
  ...
  <header id="header">
    <div class="d-flex flex-column">
      ...
      <div class="profile">
        ...
        <h1 class="text-light"><a href="index.html">Nakheem</a></h1>
        <div class="social-links mt-3 text-center">
          <a href="https://www.facebook.com/public/Nakheem-Duhaney" class="facebook"><i class="bx bxl-facebook"></i></a>
          <a href="https://www.instagram.com/aka_naknak" class="instagram"><i class="bx bxl-instagram"></i></a>
          <a href="https://ca.linkedin.com/in/nakheem-duhaney-9729b090" class="linkedin"><i class="bx bxl-linkedin"></i></a>
          <a href="https://github.com/Nakheem" class="github"><i class="bx bxl-github"></i></a>
        </div>
      </div>
  ...
  <section id="hero" class="d-flex flex-column justify-content-center align-items-center">
    <div class="hero-container" data-aos="fade-in">
      <h1>Nakheem Duhaney</h1>
      <p>I'm <span class="typed" data-typed-items="Designer, Developer,Game Developer, Artist"></span></p>
    </div>
  </section><!-- End Hero -->
        ...
        <div class="row">
          ...
          <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
            ...
            <div class="row">
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-chevron-right"></i> <strong>Website:</strong> <span>NakNak.ca</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>City:</strong> <span>Kelowna, British Columbia</span></li>
                </ul>
              </div>
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-chevron-right"></i> <strong>Degree:</strong> <span>Bachelor's of Science in Computer Science</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Email:</strong> <span>nakheem.duhaney@hotmail.com </span></li>
                </ul>
              </div>
            </div>
            <p>
      ...
      <div class="container">
        ...
        <div class="row skills-content">
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="progress">
              <span class="skill">Tableu <i class="val">55%</i></span>
              <div class="progress-bar-wrap">
